<%@ Page Title="Registro" Language="C#" MasterPageFile="~/Pages/default.Master" AutoEventWireup="true" CodeBehind="damwebend3.aspx.cs" Inherits="GTI_Web.Pages.damwebend3" %>
<asp:Content ID="Content" ContentPlaceHolderID="MenuContentPlaceHolder" runat="server" >
    ...
    <%--<form id="pagamento" runat="server" action="https://mpag.bb.com.br/site/mpag/" method="post" name="pagamento">--%>
        ...
        <asp:Button ID="btGerar" runat="server" Text="Imprimir Boleto" class="button1"  OnClientClick="SubForm()"   />
        &nbsp;&nbsp;&nbsp;
        </div>
    ...
    <script>
        function SubForm() {
            ...
            $.ajax({
                ...
                type: 'post',
                data: {
                    msgLoja: "RECEBER SOMENTE ATE O VENCIMENTO, APOS ATUALIZAR O BOLETO NO SITE www.jaboticabal.sp.gov.br",
                    cep: Convert.ToInt32(RetornaNumero(txtCep.Text)),
                    uf: txtUF.Text,
