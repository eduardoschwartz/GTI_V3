    ...
    public class Imovel_Data {
        ...
        public Exception Insert_Dados_Imovel(dados_imovel_rpt Reg) {
            using (var db = new GTI_Context(_connection)) {
                ...
                Parametros[6] = new SqlParameter { ParameterName = "@numero", SqlDbType = SqlDbType.Int, SqlValue = Reg.Numero };
                Parametros[7] = new SqlParameter { ParameterName = "@complemento", SqlDbType = SqlDbType.VarChar, SqlValue = Reg.Complemento };
